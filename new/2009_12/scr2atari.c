                        ...
                        Mutex *print_mutex)
{
    ...
    else if (strcmp(format, "color") == 0)
    {
        ...
        /*
         * Color reference is RGB.
         *
         * QOI is selected automatically when the output
         * filename has .qoi extension.
         */
...
else if (strcmp(format, "colorn-grey-smartd") == 0)
{
    uint8_t *rgb;
    unsigned unique_colors;
    ...
    result =
        convert_scr_to_color_grey_smartd_reference(
            scr,
            rgb,
            &unique_colors);
...
static void usage(const char *program)
{
	...
	"  %s input.scr -colorn-grey-smartd output.png\n"
        "  %s input.scr -color -nearest output.png\n"
        "  %s input.scr -color -nearest -bres output.png\n"
        "  %s input.scr -color -nearest -area output.png\n"
        "  %s input.scr -color -grey output.png\n"
        "  %s input.scr -color -grey -bres output.png\n"
        "  %s input.scr -color -grey -mix output.png\n"
        "  %s input.scr -color -grey -mix -bres output.png\n"
        "  %s *.scr -xex\n"
        "  %s *.scr -png -j 8\n"
	...
	"  -colorn-grey-smartd  smart grayscale with dithering\n"
        "  -color       new color conversion pipeline\n"
        "  -nearest     nearest GTIA color model\n"
        "  -grey        four-level grayscale model\n"
        "  -bres        Bresenham spatial filter\n"
        "  -area        area spatial filter\n"
        "  -mix         enable grayscale MIX representation\n"
        "  -d          Floyd-Steinberg dithering\n"
...
if (strcmp(arg, "-colorn-grey-smartd") == 0)
{
    format = "colorn-grey-smartd";
...

    {
        ...
        args.quiet = quiet;
	args.color_options = color_options;
