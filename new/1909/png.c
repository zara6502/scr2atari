              ...
              unsigned height)
{
...

    {
        ...
        ihdr[0] = (uint8_t)((width >> 24) & 255);
        ihdr[1] = (uint8_t)((width >> 16) & 255);
        ihdr[2] = (uint8_t)((width >> 8) & 255);
        ihdr[3] = (uint8_t)(width & 255);

        ihdr[4] = (uint8_t)((height >> 24) & 255);
        ihdr[5] = (uint8_t)((height >> 16) & 255);
        ihdr[6] = (uint8_t)((height >> 8) & 255);
        ihdr[7] = (uint8_t)(height & 255);
