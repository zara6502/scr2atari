...
public:
     ...
     *
     * The encoder compares complete archive sizes:
     *
     *     v6 global Huffman
     *     v7 compact delta model
     *
     * v7 is selected only when it is strictly smaller.
     * Equal size selects the old v6 global format.
     */
    bool encodeArchive(
